...
void SetKnobColorRgb (uint8_t which, uint8_t red, uint8_t green, uint8_t blue);
...
{   
    ...
    {   
        ...
        if (ReceivedDataBuffer[0] == 2) {
            SetKnobColorRgb (0, ReceivedDataBuffer[1], ReceivedDataBuffer[2], ReceivedDataBuffer[3]);
            SetKnobColorRgb (1, ReceivedDataBuffer[4], ReceivedDataBuffer[5], ReceivedDataBuffer[6]);
            SetKnobColorRgb (2, ReceivedDataBuffer[7], ReceivedDataBuffer[8], ReceivedDataBuffer[9]);
            SetKnobColorRgb (3, ReceivedDataBuffer[10], ReceivedDataBuffer[11], ReceivedDataBuffer[12]);
